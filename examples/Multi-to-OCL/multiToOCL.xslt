...
<xsl:stylesheet xmlns:my="http:///rcos.iist.unu.edu/2008/lidan"
   ...
   <xsl:template match="ownedAttribute[lowerValue[@xmi:type='uml:LiteralInteger' and @value='1'] and my:xmiXMIrefs(@type)[@xmi:type='uml:Class'] and upperValue[@xmi:type='uml:LiteralUnlimitedNatural' and @value='1'] and my:xmiXMIrefs(@association)[@xmi:type='uml:Association']]"
                 mode="AssoEndToOCL"
                 priority="10">
   ...
   <xsl:template match="ownedAttribute[lowerValue[@xmi:type='uml:LiteralInteger'] and upperValue[@xmi:type='uml:LiteralUnlimitedNatural'] and my:xmiXMIrefs(@association)[@xmi:type='uml:Association'] and my:xmiXMIrefs(@type)[@xmi:type='uml:Class']]"
                 mode="AssoEndToOCL">
   ...
   <xsl:template match="ownedAttribute[empty(current()/lowerValue[@xmi:type='uml:LiteralInteger']/@value) and my:xmiXMIrefs(@type)[@xmi:type='uml:Class'] and my:xmiXMIrefs(@association)[@xmi:type='uml:Association'] and lowerValue[@xmi:type='uml:LiteralInteger'] and upperValue[@xmi:type='uml:LiteralUnlimitedNatural' and @value='*']]"
                 mode="AssoEndToOCL"
                 priority="100">
