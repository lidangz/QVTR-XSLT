...
<xsl:stylesheet xmlns:my="http:///rcos.iist.unu.edu/2008/lidan"
   ...
   <xsl:template match="node[@xmi:type='uml:ForkNode' and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow']]"
                 mode="ForkNodeLast">
      ...
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($fn/@outgoing)[@xmi:type='uml:ControlFlow'][last()]/@name"/>
      <xsl:element name="Process">
         <xsl:attribute name="name" select="$aenm"/>
         <xsl:attribute name="type" select="'RIGHT'"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="edge[@xmi:type='uml:ControlFlow' and my:xmiXMIrefs(@target)]"
                 mode="EdgeToPA">
   ...
   <xsl:template match="node[@xmi:type='uml:DecisionNode' and count(my:xmiXMIrefs(current()/@outgoing)[@xmi:type='uml:ControlFlow']) &gt; 1 and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow' and guard[@xmi:type='uml:OpaqueExpression']]]"
                 mode="DecisionNode">
      ...
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow'][guard[@xmi:type='uml:OpaqueExpression']/body!='else'][1]/@name"/>
      <xsl:variable name="condi"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow'][guard[@xmi:type='uml:OpaqueExpression']/body!='else'][1]/guard[@xmi:type='uml:OpaqueExpression']/body"/>
      <xsl:variable name="pos" select="2"/>
      <xsl:variable name="newae"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow'][guard[@xmi:type='uml:OpaqueExpression']/body!='else'][$pos]"/>
   ...
   <xsl:template match="node[@xmi:type='uml:ForkNode' and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow']]"
      ...
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($fn/@outgoing)[@xmi:type='uml:ControlFlow'][$pos]/@name"/>
      <xsl:variable name="nae"
                    select="my:xmiXMIrefs($fn/@outgoing)[@xmi:type='uml:ControlFlow'][$nnpos]"/>
   ...
   <xsl:template match="node[@xmi:type='uml:DecisionNode' and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow' and guard[@xmi:type='uml:OpaqueExpression']]]"
                 mode="DecisionNodeLast">
      <xsl:message select="concat('DecisionNodeLast',' : ',@xmi:id,' : ',@name)"/>
      <xsl:variable name="dn" select="current()"/>
      <xsl:variable name="ad" select="$dn/parent::node()"/>
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow'][guard[@xmi:type='uml:OpaqueExpression']/body='else']/@name"/>
      <xsl:element name="Process">
         <xsl:attribute name="name" select="$aenm"/>
         <xsl:attribute name="type" select="'RIGHT'"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="node[@xmi:type='uml:ForkNode' and count(my:xmiXMIrefs(current()/@outgoing)[@xmi:type='uml:ControlFlow'])=1 and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow'] and my:xmiXMIrefs(@incoming)[@xmi:type='uml:ControlFlow']]"
                 mode="JoinNode">
      <xsl:param name="ineg"/>
      ...
      <xsl:variable name="fnm"
                    select="my:xmiXMIrefs($fn/@incoming)[@xmi:type='uml:ControlFlow'][1]/@name"/>
      <xsl:variable name="ept"
                    select="my:xmiXMIrefs($fn/@outgoing)[@xmi:type='uml:ControlFlow'][2]"/>
   ...
   <xsl:template match="node[@xmi:type='uml:ForkNode' and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow']]"
      ...
      <xsl:variable name="fn" select="current()"/>
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($fn/@outgoing)[@xmi:type='uml:ControlFlow']/@name"/>
   ...
   <xsl:template match="node[@xmi:type='uml:DecisionNode' and count(my:xmiXMIrefs(current()/@outgoing)[@xmi:type='uml:ControlFlow'])=1 and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow']]"
                 mode="MergeNode">
      <xsl:message select="concat('MergeNode',' : ',@xmi:id,' : ',@name)"/>
      <xsl:variable name="dn" select="current()"/>
      <xsl:variable name="ad" select="$dn/parent::node()"/>
      <xsl:variable name="aenm2"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow']/@name"/>
      <xsl:element name="Process">
         <xsl:attribute name="name" select="$aenm2"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="node[@xmi:type='uml:DecisionNode' and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow' and guard[@xmi:type='uml:OpaqueExpression']]]"
                 mode="DecisionNodeNext">
      <xsl:param name="pos"/>
      <xsl:message select="concat('DecisionNodeNext',' : ',@xmi:id,' : ',@name)"/>
      <xsl:variable name="dn" select="current()"/>
      <xsl:variable name="ad" select="$dn/parent::node()"/>
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow'][guard[@xmi:type='uml:OpaqueExpression']/body!='else'][$pos]/@name"/>
      <xsl:variable name="condi"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow'][guard[@xmi:type='uml:OpaqueExpression']/body!='else'][$pos]/guard[@xmi:type='uml:OpaqueExpression']/body"/>
      <xsl:variable name="newpos" select="$pos + 1"/>
      <xsl:variable name="newae"
                    select="my:xmiXMIrefs($dn/@outgoing)[@xmi:type='uml:ControlFlow'][guard[@xmi:type='uml:OpaqueExpression']/body!='else'][$newpos]"/>
      <xsl:element name="Condition">
         <xsl:attribute name="expression" select="$condi"/>
         <xsl:attribute name="type" select="'RIGHT'"/>
         <xsl:element name="Process">
   ...
   <xsl:template match="node[@xmi:type='uml:CallBehaviorAction' and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow']]"
                 mode="ActionToPrefix">
      <xsl:message select="concat('ActionToPrefix',' : ',@xmi:id,' : ',@name)"/>
      <xsl:variable name="acnm" select="current()/@name"/>
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs(current()/@outgoing)[@xmi:type='uml:ControlFlow']/@name"/>
   ...
   <xsl:template match="node[@xmi:type='uml:ForkNode' and count(my:xmiXMIrefs(current()/@outgoing)[@xmi:type='uml:ControlFlow']) &gt; 1 and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow'][1]]"
                 mode="ForkNode">
      <xsl:message select="concat('ForkNode',' : ',@xmi:id,' : ',@name)"/>
      <xsl:variable name="fn" select="current()"/>
      <xsl:variable name="ad" select="$fn/parent::node()"/>
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($fn/@outgoing)[@xmi:type='uml:ControlFlow'][1]/@name"/>
      <xsl:variable name="pos" select="2"/>
      <xsl:variable name="npos" select="$pos + 1"/>
      <xsl:variable name="nae"
                    select="my:xmiXMIrefs($fn/@outgoing)[@xmi:type='uml:ControlFlow'][$npos]"/>
      <xsl:element name="Concurrency">
         <xsl:element name="Process">
            <xsl:attribute name="name" select="$aenm"/>
            <xsl:attribute name="type" select="'LEFT'"/>
   ...
   <xsl:template match="//packagedElement[@xmi:type='uml:Activity' and node[@xmi:type='uml:InitialNode' and my:xmiXMIrefs(@outgoing)[@xmi:type='uml:ControlFlow']]]"
                 mode="ActivitityToCSP">
      <xsl:message select="concat('ActivitityToCSP',' : ',@xmi:id,' : ',@name)"/>
      <xsl:variable name="ad" select="current()"/>
      <xsl:variable name="aenm"
                    select="my:xmiXMIrefs($ad/node[@xmi:type='uml:InitialNode']/@outgoing)[@xmi:type='uml:ControlFlow']/@name"/>
