...
<!--Source model name : C:\sharefile\QVTR_XSLT homepage\test\Multi-to-OCL-transfor.xml--><xsl:stylesheet xmlns:my="http:///rcos.iist.unu.edu/2008/lidan"
   ...
   <!--Relation : AssoEndToOCL_No--><xsl:template match="ownedAttribute[empty(current()/lowerValue[@xmi:type='uml:LiteralInteger']/@value) and my:xmiXMIrefs(@association)[@xmi:type='uml:Association'] and upperValue[@xmi:type='uml:LiteralUnlimitedNatural' and matches(@value,'*')] and my:xmiXMIrefs(@type)[@xmi:type='uml:Class'] and lowerValue[@xmi:type='uml:LiteralInteger']]"
                 mode="AssoEndToOCL"
                 priority="100">
   ...
   <!--Relation : AssoEndToOCL--><xsl:template match="ownedAttribute[my:xmiXMIrefs(@association)[@xmi:type='uml:Association'] and my:xmiXMIrefs(@type)[@xmi:type='uml:Class'] and upperValue[@xmi:type='uml:LiteralUnlimitedNatural'] and lowerValue[@xmi:type='uml:LiteralInteger']]"
                 mode="AssoEndToOCL">
      <xsl:param name="_targetDom_Key"/>
      <xsl:variable name="asn" select="current()"/>
   ...
   <!--Relation : AssoEndToOCL_1--><xsl:template match="ownedAttribute[my:xmiXMIrefs(@type)[@xmi:type='uml:Class'] and lowerValue[@xmi:type='uml:LiteralInteger' and @value='1'] and my:xmiXMIrefs(@association)[@xmi:type='uml:Association'] and upperValue[@xmi:type='uml:LiteralUnlimitedNatural' and @value='1']]"
                 mode="AssoEndToOCL"
                 priority="10">
      <xsl:param name="_targetDom_Key"/>
      <xsl:variable name="asn" select="current()"/>
