...
<xsl:stylesheet xmlns:my="http:///rcos.iist.unu.edu/2008/lidan"
   ...
   <xsl:template match="ownedAttribute[not(my:xmiXMIrefs(@association)[@xmi:type='uml:Association']) and my:xmiXMIrefs(@type)[@xmi:type='uml:Class']]"
   ...
   <xsl:template match="ownedAttribute[upperValue[@xmi:type='uml:LiteralUnlimitedNatural' and @value='1'] and my:xmiXMIrefs(@association)[@xmi:type='uml:Association'] and my:xmiXMIrefs(@type)[@xmi:type='uml:Class' and not(@isAbstract='true')]]"
                 mode="AssocEndToFKey">
      <xsl:param name="_targetDom_Key"/>
   ...
   <xsl:template match="ownedAttribute[type[@xmi:type='uml:PrimitiveType']]"
   ...
   <xsl:template match="generalization[my:xmiXMIrefs(@general)[@xmi:type='uml:Class']]"
